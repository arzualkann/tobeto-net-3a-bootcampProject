        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BlackList_Applicants_Applicant_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bootcamp_BootcampStates_BootcampStateId",
                        column: x => x.BootcampStateId,
                        principalTable: "BootcampStates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Bootcamp_Instructors_InstructorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlackList_Applicant_id",
                table: "BlackList",
                column: "Applicant_id",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Bootcamp_BootcampStateId",
                table: "Bootcamp",
                column: "BootcampStateId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Bootcamp_InstructorId",
                table: "Bootcamp",
                column: "InstructorId");
        }
